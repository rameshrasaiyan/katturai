...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <article class="articles">
    <header class="article-header">
      <ul>
        <li>
          <span class="glyphicon glyphicon-time"></span><span class="month"><?php print $date_month ?></span>
          <span class="day"><?php print $date_day ?>, </span>
          <span class="year"><?php print $date_year ?></span>
      </li>
       <?php if ($display_submitted): ?>
        <li><span class="glyphicon glyphicon-user"></span><?php print $name; ?></li>
        <?php endif; ?>
      </ul>
    </header>
    <div class="article-content">
      ...
      <?php print render($title_prefix); ?>
        <?php if (!$page): ?>
          <h2<?php print $title_attributes; ?> class="article-title"><a href="<?php print $node_url; ?>"><?php print $title; ?></a></h2>
        <?php endif; ?>
      ...
      <span class="readmore">
        <?php if($teaser): ?>
          <?php print $newreadmore; ?><span class="glyphicon glyphicon-chevron-right"></span>
      <?php endif; ?>
    </div>
